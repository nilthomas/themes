			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-mg-6 col-sm-6 col-xs-12">
						<img src="image/catalog/demo/another/page404.png" class="img-responsive float-lg-right" alt="">
					</div>
					<div class="col-lg-6 col-mg-6 col-sm-6 col-xs-12 message-box">
						<h1 class="message-title">WE CAN’T FIND THE PAGE YOU’RE LOOKING FOR</h1>
						<a href="index.php" class="smooth go-home-page">
							<i class="fa fa-home"></i>
							GO TO HOMEPAGE
						</a>
					</div>
