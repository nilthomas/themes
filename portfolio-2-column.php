...
<body class="common-here res layout-1">
  ...
  <div id="wrapper" class="wrapper-fluid banner-effect-3">
    ...
    <div class="breadcrumbs">
      <div class="container">
        ...
        <ul class="breadcrumb">
          ...
          <li>
            <a href="portfolio-2-column.php" class="smooth" title="">Portfolio 2 columns/a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="portfolio-2-column listing-blog">
      <div class="container">
        <h1 class="portfolio-title">portfolio 2 columns</h1>
                  ...
                  <div class="ltabs-items-inner ltabs-slider ltabs00-4 ltabs01-3 ltabs02-3 ltabs03-2 ltabs04-1 none">
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="portfolio-box">
                          <a href="portfolio-detail.php" class="c-img" title="">
                            <img src="image/catalog/demo/portfolio/portfolio1.png" alt="">
                          </a>
                        ...
                        <div class="portfolio-box">
                          <a href="portfolio-detail.php" class="c-img" title="">
                            <img src="image/catalog/demo/portfolio/portfolio2.png" alt="">
                          </a>
                          <div class="portfolio-info">
                            <div>
                              <h3 class="portfolio-name">
                        ...
                        <div class="portfolio-box">
                          <a href="portfolio-detail.php" class="c-img" title="">
                            <img src="image/catalog/demo/portfolio/portfolio3.png" alt="">
                          </a>
                          <div class="portfolio-info">
                            <div>
                              <h3 class="portfolio-name">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="portfolio-box">
                          <a href="portfolio-detail.php" class="c-img" title="">
                            <img src="image/catalog/demo/portfolio/portfolio4.png" alt="">
                          </a>
                          <div class="portfolio-info">
                            <div>
                              <h3 class="portfolio-name">
                        ...
                        <div class="portfolio-box">
                          <a href="portfolio-detail.php" class="c-img" title="">
                            <img src="image/catalog/demo/portfolio/portfolio5.png" alt="">
                          </a>
                          <div class="portfolio-info">
                            <div>
                              <h3 class="portfolio-name">
                        ...
                        <div class="portfolio-box">
                          <a href="portfolio-detail.php" class="c-img" title="">
                            <img src="image/catalog/demo/portfolio/portfolio6.png" alt="">
                          </a>
                          <div class="portfolio-info">
                            <div>
                              <h3 class="portfolio-name">
