...
<body class="common-here res layout-1">
  ...
  <div id="wrapper" class="wrapper-fluid banner-effect-3">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h1 class="category-name">LISTING BLOG 2 COLUMN</h1>
        <ul class="breadcrumb">
          <li>
            <a href="index.php" class="smooth" title="">Home</a>
          </li>
          <li>
            <a href="listing-blog-2-column.php" class="smooth" title="">Listing Blog 2 COLUMN</a>
          </li>
        </ul>
      </div>
    </div>
            ...
            <div class="aside-blog-categories">
              ...
              <div class="blog-categories-box">
                <ul>
                  ...
                  <li>
                    <a href="detail-blog.php" class="smooth" title=""><i class="fa fa-caret-right"></i>Ultrices posuere cubilia</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="col-lg-9 col-md-9">
            ...
            <div class="row">
              <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="listing-blog-item">
                  <a href="detail-blog.php" class="c-img hv-scale-bg" title="">
                    <img src="image/catalog/demo/blog/blog7.png" class="img-responsive" alt="">
                  </a>
                ...
                <div class="listing-blog-item">
                  <a href="detail-blog.php" class="c-img hv-scale-bg" title="">
                    <img src="image/catalog/demo/blog/blog9.png" class="img-responsive" alt="">
                  </a>
                  <div class="blog-item-desc-box">
                    <div class="blog-item-info">
                      <h3 class="blog-item-title">
              ...
              <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="listing-blog-item">
                  <a href="detail-blog.php" class="c-img hv-scale-bg" title="">
                    <img src="image/catalog/demo/blog/blog8.png" class="img-responsive" alt="">
                  </a>
                  <div class="blog-item-desc-box">
                    <div class="blog-item-info">
                      <h3 class="blog-item-title">
                ...
                <div class="listing-blog-item">
                  <a href="detail-blog.php" class="c-img hv-scale-bg" title="">
                    <img src="image/catalog/demo/blog/blog10.png" class="img-responsive" alt="">
                  </a>
                  <div class="blog-item-desc-box">
                    <div class="blog-item-info">
                      <h3 class="blog-item-title">
