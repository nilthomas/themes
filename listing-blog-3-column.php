...
<body class="common-here res layout-1">
	...
	<div id="wrapper" class="wrapper-fluid banner-effect-3">
		...
		<div class="breadcrumbs">
			<div class="container">
				<h1 class="category-name">LISTING BLOG 3 COLUMN</h1>
				<ul class="breadcrumb">
					<li>
						<a href="index.php" class="smooth" title="">Home</a>
					</li>
					<li>
						<a href="listing-blog-3-column.php" class="smooth" title="">Listing Blog 3 column</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="detail-sidebar listing-blog listing-blog-2-column listing-blog-3-column">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 listing-blog-column">
						<div class="listing-blog-item">
							<a href="detail-blog.php" class="c-img hv-scale-bg" title="">
								<img src="image/catalog/demo/blog/blog11.png" class="img-responsive" alt="">
							</a>
							<div class="blog-item-desc-box">
								<div class="blog-item-info">
									<h3 class="blog-item-title">
										<a href="detail-blog.php" class="smooth" title="">Quisque non turpis sed eros semper conge</a>
									</h3>
						...
						<div class="listing-blog-item">
							<a href="detail-blog.php" class="c-img hv-scale-bg" title="">
								<img src="image/catalog/demo/blog/blog12.png" class="img-responsive" alt="">
							</a>
							<div class="blog-item-desc-box">
								<div class="blog-item-info">
									<h3 class="blog-item-title">
					...
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 listing-blog-column">
						<div class="listing-blog-item">
							<a href="detail-blog.php" class="c-img hv-scale-bg" title="">
								<img src="image/catalog/demo/blog/blog13.png" class="img-responsive" alt="">
							</a>
							<div class="blog-item-desc-box">
								<div class="blog-item-info">
									<h3 class="blog-item-title">
										<a href="detail-blog.php" class="smooth" title="">Pellentesque lorem diam, vehicula non ligula ut, dictum luctus leo</a>
									</h3>
									<div class="blog-item-info-post">
										<div class="blog-info-post-item">
											<i class="fa fa-user"></i>Super User
									...
									<p class="blog-item-desc">Lorem ipsum dolor sit amet, consecte adipiscing elit. Pellentesque diam sem, hendrerit ut faucibus amet, bibendum vel lacus. Vestibulum pharetra varius ornare...</p>
								</div>
							</div>
						</div>
						...
						<div class="listing-blog-item listing-blog-no-image">
							<div class="blog-item-desc-box">
								<div class="blog-item-info">
									...
									<p class="blog-item-desc">Lorem ipsum dolor sit amet, consecte adipiscing elit. Pellentesque diam sem, hendrerit ut faucibus amet, bibendum vel lacus. Vestibulum pharetra varius ornare...
						...
						<div class="listing-blog-item">
							<a href="detail-blog.php" class="c-img hv-scale-bg" title="">
								<img src="image/catalog/demo/blog/blog14.png" class="img-responsive" alt="">
							</a>
							<div class="blog-item-desc-box">
								<div class="blog-item-info">
									<h3 class="blog-item-title">
					...
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 listing-blog-column">
						<div class="listing-blog-item">
							<a href="detail-blog.php" class="c-img hv-scale-bg" title="">
								<img src="image/catalog/demo/blog/blog15.png" class="img-responsive" alt="">
							</a>
							<div class="blog-item-desc-box">
								<div class="blog-item-info">
									<h3 class="blog-item-title">
						...
						<div class="listing-blog-item">
							<a href="detail-blog.php" class="c-img hv-scale-bg" title="">
								<img src="image/catalog/demo/blog/blog16.png" class="img-responsive" alt="">
							</a>
							<div class="blog-item-desc-box">
								<div class="blog-item-info">
									<h3 class="blog-item-title">
