...
<body class="commpn-here res layout-1">
  ...
  <div id="wrapper" class="wrapper-fluid banner-effect-3">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h1 class="category-name">PRODUCT COMPARISON</h1>
        <ul class="breadcrumb">
          <li>
            <a href="index.html" class="smooth" title="">Home</a>
          </li>
          <li>
            <a href="compare.html" class="smooth" title="">Product Comparison</a>
          </li>
        </ul>
      </div>
    </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td>Product</td>
                    <td><a href="detail.php" class="product-name"><strong>Lorem ipsum dolor sit amet, consectetur adipisicing elit</strong></a></td>
                    <td><a href="detail.php" class="product-name"><strong>Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                    </strong></a></td>
                    <td><a href="detail.php" class="product-name"><strong>Girly Summer Outfit Ideas To Upgrade Your Wardrobe</strong></a></td>
                  </tr>
                  <tr>
                    <td>Image</td>
                    <td class="text-center"> <img src="image/catalog/demo/products/product46.png" alt="Bougainvilleas on Lombard Street,  San Francisco, Tokyo" title="Bougainvilleas on Lombard Street,  San Francisco, Tokyo" class="img-thumbnail" /> </td>
                    <td class="text-center"> <img src="image/catalog/demo/products/product47.png" alt="Canada Travel One or Two European Facials at  Studio" title="Canada Travel One or Two European Facials at  Studio" class="img-thumbnail" /> </td>
                    <td class="text-center"><img src="image/catalog/demo/products/product48.png" alt="Girly Summer Outfit Ideas To Upgrade Your Wardrobe" title="Girly Summer Outfit Ideas To Upgrade Your Wardrobe" class="img-thumbnail"></td>
                  </tr>
                  <tr>
                    <td>Price</td>
                ...
                <tr>
                  <td></td>
                  <td>
                    <input type="button" value="Add to Cart" class="btn btn-primary btn-block" onclick="window.location.href='cart.php'" />
