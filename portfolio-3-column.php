...
<body class="common-here res layout-1">
  ...
  <div id="wrapper" class="wrapper-fluid banner-effect-3">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h1 class="category-name">Portfolio 3 columns</h1>
        <ul class="breadcrumb">
          <li>
            <a href="index.php" class="smooth" title="">Home</a>
          </li>
          <li>
            <a href="listing-blog.php" class="smooth" title="">Listing List</a>
          </li>
          <li>
            <a href="portfolio-3-column.php" class="smooth" title="">Portfolio 3 columns</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="portfolio-2-column listing-blog portfolio-3-column">
      <div class="container">
        <h1 class="portfolio-title">portfolio 3 columns</h1>
          ...
          <div class="ltabs-wrap">
            <div class="ltabs-tabs-container clearfix" data-delay="300" data-duration="600" data-effect="starwars" data-ajaxurl="" data-type_source="0" data-lg="4" data-md="3" data-sm="2" data-xs="2" data-margin="30">
              ...
              <div class="ltabs-tabs-wrap">
                ...
                <div class="item-sub-cat">
                  <ul class="ltabs-tabs cf">
                    ...
                    <li class="ltabs-tab tab-sel" data-category-id="1" data-active-content=".all"> <span class="ltabs-tab-label smooth">All </span></li>
                    <li class="ltabs-tab " data-category-id="2" data-active-content=".advertising"> <span class="ltabs-tab-label smooth">Advertising</span></li>
                    <li class="ltabs-tab " data-category-id="3" data-active-content=".design"> <span class="ltabs-tab-label smooth">Design</span> </li>
                    <li class="ltabs-tab " data-category-id="4" data-active-content=".development"> <span class="ltabs-tab-label smooth">Development</span> </li>
                    <li class="ltabs-tab " data-category-id="5" data-active-content=".photography"> <span class="ltabs-tab-label smooth">Photography</span> </li>
                  </ul>
                </div>
              </div>
              <!-- End Tabs-->
              ...
              <div class="wap-listing-tabs ltabs-items-container products-list grid">
                <!--Begin Items-->
                <div class="ltabs-items ltabs-items-selected all" data-total="16">
                  <div class="ltabs-items-inner ltabs-slider ltabs00-4 ltabs01-3 ltabs02-3 ltabs03-2 ltabs04-1 none">

                   <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 portfolio-column">
                      <div class="portfolio-box">
                        <a href="portfolio-detail.php" class="c-img" title="">
                          <img src="image/catalog/demo/portfolio/portfolio7.png" alt="">
                        </a>
                        <div class="portfolio-info">
                          <div>
                            <h3 class="portfolio-name">
                              <a href="portfolio-detail.php" class="smooth" title="">Lorem ipsum dolor sit amet</a>
                            </h3>
                            <div class="portfolio-button-group">
                              <a href="portfolio-detail.php" class="smooth"><i class="fa fa-link" aria-hidden="true"></i></a>
                              <a class="smooth quickview iframe-link btn-button quickview quickview_handler" href="portfolio-quickview.php" title="Quick view" target="_self" data-fancybox-type="iframe">
                                <i class="fa fa-search" aria-hidden="true"></i>
                              </a>
                            </div>
                          </div>
                      ...
                      <div class="portfolio-box">
                        <a href="portfolio-detail.php" class="c-img" title="">
                          <img src="image/catalog/demo/portfolio/portfolio8.png" alt="">
                        </a>
                        <div class="portfolio-info">
                          <div>
                            <h3 class="portfolio-name">
                      ...
                      <div class="portfolio-box">
                        <a href="portfolio-detail.php" class="c-img" title="">
                          <img src="image/catalog/demo/portfolio/portfolio9.png" alt="">
                        </a>
                        <div class="portfolio-info">
                          <div>
                            <h3 class="portfolio-name">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 portfolio-column">
                      <div class="portfolio-box">
                        <a href="portfolio-detail.php" class="c-img" title="">
                          <img src="image/catalog/demo/portfolio/portfolio16.png" alt="">
                        </a>
                        <div class="portfolio-info">
                          <div>
                            <h3 class="portfolio-name">
                      ...
                      <div class="portfolio-box">
                        <a href="portfolio-detail.php" class="c-img" title="">
                          <img src="image/catalog/demo/portfolio/portfolio11.png" alt="">
                        </a>
                        <div class="portfolio-info">
                          <div>
                            <h3 class="portfolio-name">
                      ...
                      <div class="portfolio-box">
                        <a href="portfolio-detail.php" class="c-img" title="">
                          <img src="image/catalog/demo/portfolio/portfolio12.png" alt="">
                        </a>
                        <div class="portfolio-info">
                          <div>
                            <h3 class="portfolio-name">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 portfolio-column">
                      <div class="portfolio-box">
                        <a href="portfolio-detail.php" class="c-img" title="">
                          <img src="image/catalog/demo/portfolio/portfolio13.png" alt="">
                        </a>
                        <div class="portfolio-info">
                          <div>
                            <h3 class="portfolio-name">
                      ...
                      <div class="portfolio-box">
                        <a href="portfolio-detail.php" class="c-img" title="">
                          <img src="image/catalog/demo/portfolio/portfolio14.png" alt="">
                        </a>
                        <div class="portfolio-info">
                          <div>
                            <h3 class="portfolio-name">
                      ...
                      <div class="portfolio-box">
                        <a href="portfolio-detail.php" class="c-img" title="">
                          <img src="image/catalog/demo/portfolio/portfolio15.png" alt="">
                        </a>
                        <div class="portfolio-info">
                          <div>
                            <h3 class="portfolio-name">
              ...
              <div class="ltabs-items advertising" data-total="16">
                <div class="ltabs-items-inner ltabs-slider ltabs00-4 ltabs01-3 ltabs02-3 ltabs03-2 ltabs04-1 none">
              ...
              <div class="ltabs-items design" data-total="16">
                <div class="ltabs-items-inner ltabs-slider ltabs00-4 ltabs01-3 ltabs02-3 ltabs03-2 ltabs04-1 none">
              ...
              <div class="ltabs-items development" data-total="16">
                <div class="ltabs-items-inner ltabs-slider ltabs00-4 ltabs01-3 ltabs02-3 ltabs03-2 ltabs04-1 none">
              ...
              <div class="ltabs-items photography" data-total="16">
                <div class="ltabs-items-inner ltabs-slider ltabs00-4 ltabs01-3 ltabs02-3 ltabs03-2 ltabs04-1 none">
