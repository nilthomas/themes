...
<body class="common-here res layout-1">
    ...
    <div class="breadcrumbs">
      <div class="container">
        ...
        <ul class="breadcrumb">
          ...
          <li>
            <a href="category.php" class="smooth" title="">Living Room</a>
          </li>
        </ul>
      </div>
    </div> 
 ...
 <div class="product-list-view product-list-view-04">
  <div class="row">
    <div class="product-layout col-xs-12 product-layout-table">
