...
<body class="common-here res layout-1">
  ...
  <div id="wrapper" class="wrapper-fluid banner-effect-3">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h1 class="category-name">Portfolio detail</h1>
        <ul class="breadcrumb">
          <li>
            <a href="index.php" class="smooth" title="">Home</a>
          </li>
          <li>
            <a href="category.php" class="smooth" title="">Listing List</a>
          </li>
          <li>
            <a href="portfolio-detail.php" class="smooth" title="">Portfolio detail</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="portfolio-detail portfolio-2-column">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12 portfolio-detal-image">
       ...
       <div class="comment-form">
         <h5 class="project-detail-title title-underline">Leave a Comment</h5>
         <form> 
          <div class="form-top">
            <div class="row row10">
              <div class="col-lg-4 col-md-4 col-sm-12 col10 form-group">
              ...
              <div class="col-lg-4 col-md-4 col-sm-12 col10 form-group">
                <div class="input-icon input-subject">
          ...
          <button type="submit" class="hv-border-inline">Send</button>
        </form>
      </div>
      <div class="related-project">
        <h3 class="title-underline">RELATED PROJECT</h3>
        <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="portfolio-box">
              <a href="portfolio-detail.php" class="c-img" title="">
                <img src="image/catalog/demo/portfolio/portfolio18.png" alt="">
              </a>
          ...
          <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="portfolio-box">
              <a href="portfolio-detail.php" class="c-img" title="">
                <img src="image/catalog/demo/portfolio/portfolio19.png" alt="">
              </a>
              <div class="portfolio-info">
                <div>
                  <h3 class="portfolio-name">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="portfolio-box">
              <a href="portfolio-detail.php" class="c-img" title="">
                <img src="image/catalog/demo/portfolio/portfolio20.png" alt="">
              </a>
              <div class="portfolio-info">
                <div>
                  <h3 class="portfolio-name">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="portfolio-box">
              <a href="portfolio-detail.php" class="c-img" title="">
                <img src="image/catalog/demo/portfolio/portfolio21.png" alt="">
              </a>
              <div class="portfolio-info">
                <div>
                  <h3 class="portfolio-name">
