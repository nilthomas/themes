...
<body class="commpn-here res layout-1">
  ...
  <div id="wrapper" class="wrapper-fluid banner-effect-3">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h1 class="category-name">MY WISHLISH</h1>
        <ul class="breadcrumb">
          <li>
            <a href="index.php" class="smooth" title="">Home</a>
          </li>
          <li>
            <a href="wishlist.php" class="smooth" title="">My Wishlist</a>
          </li>
        </ul>
      </div>
    </div>

    <div class="wishlist my-account">
      <div class="container">
        <div class="row">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="text-center">
                      <a href="product.html"><img src="image/catalog/demo/products/product1.jpg" alt="Burger King Japan debuts Monster  Baby Force Bralette" title="Burger King Japan debuts Monster  Baby Force Bralette" class="img-thumbnail"></a>
                    </td>
                    <td class="text-left"><a href="product.html">Shoulder mollit exercita </a></td>
                    ...
                    <td class="text-right">
                      <button type="button" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add to Cart"><i class="fa fa-shopping-cart"></i></button>
                      <a href="#" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="Remove"><i class="fa fa-times"></i></a></td>
                    </tr>
                    <tr>
                      <td class="text-center">
                        <a href="product.html"><img src="image/catalog/demo/products/product4.jpg" alt="Canada Travel One or Two European Facials at  Studio" title="Canada Travel One or Two European Facials at  Studio" class="img-thumbnail"></a>
                      </td>
                      <td class="text-left"><a href="product.html">Lorem ipsum dolor sit amet, consectetur adipisicing elit</a></td>
                      ...
                      <td class="text-right">
                        <button type="button" onclick="window.location.href='compare.php'" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add to Cart"><i class="fa fa-shopping-cart"></i></button>
                        <a href="#" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="Remove"><i class="fa fa-times"></i></a></td>
                      </tr>
                    </tbody>
