		...
		<div class="breadcrumbs">
			<div class="container">
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="#" class="smooth" title="">Listing List</a>
					</li>
					<li>
		...
		<div class="faq-container">
			<div class="container">
				...
				<ul class="nav nav-tabs faq-tabs">
					<li class="active"><a class="smooth" data-toggle="tab" href="#faq-all">All</a></li>
					<li><a class="smooth" data-toggle="tab" href="#faq-fashion">Fashion</a></li>
					<li><a class="smooth" data-toggle="tab" href="#faq-electronics">Electronics</a></li>
					<li><a class="smooth" data-toggle="tab" href="#faq-user-interface">User Interface</a></li>
				</ul>

				<div class="tab-content">
					<div id="faq-all" class="tab-pane fade in active">
						<ul class="yt-accordion">
							<li class="accordion-group">
								<h3 class="accordion-heading">Lorem ipsum dolor sit amet, consectetuer adipiscing elit
							...
							<li class="accordion-group">
								<h3 class="accordion-heading">Donec eros tellus scelerisque nec rhoncus eget laoreet sit amet
									<i class="fa fa-plus-circle" aria-hidden="true"></i>
								</h3>
								<div class="accordion-inner">
									<p>Fusce eu dui. Integer vel nibh sit amet turpis vulputate aliquet. Phasellus id nisi vitae odio pretium aliquam. Pellentesque a leo. Donec consequat lectus sed felis. Quisque vestibulum massa. Nulla ornare. Nulla libero. Donec et mi eu massa ultrices scelerisque. </p>
							...
							<li class="accordion-group">
								<h3 class="accordion-heading">Curabitur molestie euismod erat. Proin eros odio?
									<i class="fa fa-plus-circle" aria-hidden="true"></i>
								</h3>
								<div class="accordion-inner" >
									<p>Fusce eu dui. Integer vel nibh sit amet turpis vulputate aliquet. Phasellus id nisi vitae odio pretium aliquam. Pellentesque a leo. Donec consequat lectus sed felis. Quisque vestibulum massa. Nulla ornare. Nulla libero. Donec et mi eu massa ultrices scelerisque.</p>
							...
							<li class="accordion-group">
								<h3 class="accordion-heading">In scelerisque sem at dolor. Maecenas mattis
									<i class="fa fa-plus-circle" aria-hidden="true"></i>
								</h3>
								<div class="accordion-inner">
							...
							<li class="accordion-group">
								<h3 class="accordion-heading">Nunc feugiat mi a tellus consequat imperdiet
									<i class="fa fa-plus-circle" aria-hidden="true"></i>
								</h3>
								<div class="accordion-inner">
									<p>Fusce eu dui. Integer vel nibh sit amet turpis vulputate aliquet. Phasellus id nisi vitae odio pretium aliquam. Pellentesque a leo. Donec consequat lectus sed felis. Quisque vestibulum massa. Nulla ornare. Nulla libero. Donec et mi eu massa ultrices scelerisque. Nullam ac nisi non eros gravida venenatis. Ut euismod, turpis sollicitudin lobortis pellentesque, libero massa dapibus dui, eu dictum justo urna et mi. Integer dictum est vitae sem. Vestibulum justo. Nulla mauris ipsum, convallis ut, vestibulum eu, tincidunt vel, nisi.</p>
							...
							<li class="accordion-group">
								<h3 class="accordion-heading">Vestibulum ante ipsum primis in faucibus orci luctus
									<i class="fa fa-plus-circle" aria-hidden="true"></i>
								</h3>
								<div class="accordion-inner" >
									<p>Fusce eu dui. Integer vel nibh sit amet turpis vulputate aliquet. Phasellus id nisi vitae odio pretium aliquam. Pellentesque a leo. Donec consequat lectus sed felis. Quisque vestibulum massa. Nulla ornare. Nulla libero. Donec et mi eu massa ultrices scelerisque. Nullam ac nisi non eros gravida venenatis. Ut euismod, turpis sollicitudin lobortis pellentesque, libero massa dapibus dui, eu dictum justo urna et mi. Integer dictum est vitae sem. Vestibulum justo. Nulla mauris ipsum, convallis ut, vestibulum eu, tincidunt vel, nisi.</p>
							...
							<li class="accordion-group">
								<h3 class="accordion-heading">SmartAddons membership fee is one-time fee, or I have to pay extra?
									<i class="fa fa-plus-circle" aria-hidden="true"></i>
								</h3>
								<div class="accordion-inner" >
									<p>Fusce eu dui. Integer vel nibh sit amet turpis vulputate aliquet. Phasellus id nisi vitae odio pretium aliquam. Pellentesque a leo. Donec consequat lectus sed felis. Quisque vestibulum massa. Nulla ornare. Nulla libero. Donec et mi eu massa ultrices scelerisque. Nullam ac nisi non eros gravida venenatis. Ut euismod, turpis sollicitudin lobortis pellentesque, libero massa dapibus dui, eu dictum justo urna et mi. Integer dictum est vitae sem. Vestibulum justo. Nulla mauris ipsum, convallis ut, vestibulum eu, tincidunt vel, nisi.</p>
					...
					<div id="faq-fashion" class="tab-pane fade">
						<ul class="yt-accordion">
							<li class="accordion-group">
								<h3 class="accordion-heading">Lorem ipsum dolor sit amet, consectetuer adipiscing elit
									<i class="fa fa-plus-circle" aria-hidden="true"></i>
					...
					<div id="faq-electronics" class="tab-pane fade">
						<ul class="yt-accordion">
							<li class="accordion-group">
								<h3 class="accordion-heading">Lorem ipsum dolor sit amet, consectetuer adipiscing elit
									<i class="fa fa-plus-circle" aria-hidden="true"></i>
					...
					<div id="faq-user-interface" class="tab-pane fade">
						<ul class="yt-accordion">
							<li class="accordion-group">
								<h3 class="accordion-heading">Lorem ipsum dolor sit amet, consectetuer adipiscing elit
									<i class="fa fa-plus-circle" aria-hidden="true"></i>
