				...
				<div class="row">
					...
					<div class="col-lg-9 col-md-9">
						...
						<div class="blog-detail-content">
							<image src="image/catalog/demo/blog/blog-detail.png" class="img-responsive" alt="">
							</div>
								...
								<div class="clearfix">
									<div class="author-avatar">
										<a href="#" class="hv-radial" title="">
											<img src="image/catalog/demo/blog/author-avatar.png" class="img-responsive" alt="">
										</a>
									</div>
								...
								<div class="row row10">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 col-12 col10 related-post-box">
										<a href="blog-detail.php" class="c-img hv-light">
											<img src="image/catalog/demo/blog/blog4.png" class="img-responsive" alt="">
										</a>
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 col-12 col10 related-post-box">
										<a href="blog-detail.php" class="c-img hv-light">
											<img src="image/catalog/demo/blog/blog5.png" class="img-responsive" alt="">
										</a>
										<h4 class="related-post-title">
											<a href="blog-detail.php" class="smooth" title="">Excepteur sint occaecat</a>
										</h4>
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 col-12 col10 related-post-box">
										<a href="blog-detail.php" class="c-img hv-light">
											<img src="image/catalog/demo/blog/blog6.png" class="img-responsive" alt="">
										</a>
										<h4 class="related-post-title">
											<a href="blog-detail.php" class="smooth" title="">Excepteur sint occaecat</a>
										</h4>
							...
							<div class="comment-container">
								...
								<div class="comment-box">
									<div class="comment-box-top clearfix">
										<div class="comment-avatar">
											<img src="image/catalog/demo/blog/comment-avtar1.png" class="img-responsive" alt="">
										</div>
								...
								<div class="comment-box">
									<div class="comment-box-top clearfix">
										<div class="comment-avatar">
											<img src="image/catalog/demo/blog/comment-avtar2.png" class="img-responsive" alt="">
										</div>
										<div class="comment-top-right">
											<div class="comment-rating">
												<div class="rating">
